...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'user_id', 'permission_id', 'tenant_id', 'scope', 'effect', 'granted_by', 'granted_at', 'expires_at' ];
    }
    ...
    {
        $x = [ 'id', 'user_id', 'permission_id', 'tenant_id', 'scope', 'effect', 'granted_by', 'granted_at', 'expires_at' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'users' => 'j0', 'permissions' => 'j1', 'tenants' => 'j2' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RbacUserPermissions\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RbacUserPermissions\Definitions::softDeleteColumn();
