...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rbac_user_permissions'; }
    public static function contractView(): string { return 'vw_rbac_user_permissions'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'user_id', 'permission_id', 'tenant_id', 'scope', 'effect', 'granted_by', 'granted_at', 'expires_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'user_id', 'permission_id', 'tenant_id', 'scope' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'user_id', 'permission_id', 'tenant_id', 'granted_by' ]; }
