...
namespace BlackCat\Database\Packages\RbacUserPermissions\Mapper;

use BlackCat\Database\Packages\RbacUserPermissions\Dto\RbacUserPermissionDto;
use BlackCat\Database\Packages\RbacUserPermissions\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RbacUserPermissionDto:
 ...
 */
final class RbacUserPermissionDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'user_id' => 'userId', 'permission_id' => 'permissionId', 'tenant_id' => 'tenantId', 'scope' => 'scope', 'effect' => 'effect', 'granted_by' => 'grantedBy', 'granted_at' => 'grantedAt', 'expires_at' => 'expiresAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'user_id', 'permission_id', 'tenant_id', 'granted_by' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'granted_at', 'expires_at' ];
    /** @var string[] */
     ...
     * @return RbacUserPermissionDto
     */
    public static function fromRow(array $row): RbacUserPermissionDto
    {
        /** @var RbacUserPermissionDto */
        return DtoHydrator::fromRow(
            RbacUserPermissionDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RbacUserPermissionDto
    {
     ...
     *
     * @param RbacUserPermissionDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RbacUserPermissionDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RbacUserPermissionDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RbacUserPermissionDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RbacUserPermissionDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RbacUserPermissionDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RbacUserPermissionDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RbacUserPermissionDto>
     */
