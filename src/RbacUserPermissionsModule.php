...
final class RbacUserPermissionsModule implements ModuleInterface
{
    public function name(): string { return 'table-rbac_user_permissions'; }
    public function table(): string { return 'rbac_user_permissions'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-permissions', 'table-tenants', 'table-users' ]; }

    public static function contractView(): string { return 'vw_rbac_user_permissions'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_rbac_up_perm', 'idx_rbac_up_user' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_rbac_up_grant', 'fk_rbac_up_perm', 'fk_rbac_up_tenant', 'fk_rbac_up_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_rbac_up_perm', 'idx_rbac_up_user' ],
            'foreignKeys' => [ 'fk_rbac_up_grant', 'fk_rbac_up_perm', 'fk_rbac_up_tenant', 'fk_rbac_up_user' ],
        ];
    }
}
