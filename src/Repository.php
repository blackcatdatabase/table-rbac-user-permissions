...
use BlackCat\Database\Packages\RbacUserPermissions\Repository\RbacUserPermissionRepository;
...
{
    private RbacUserPermissionRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new RbacUserPermissionRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacUserPermissions\Dto\RbacUserPermissionDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RbacUserPermissions\Dto\RbacUserPermissionDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacUserPermissions\Dto\RbacUserPermissionDto|null
    {
