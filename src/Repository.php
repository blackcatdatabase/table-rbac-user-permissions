...
namespace BlackCat\Database\Packages\RbacUserPermissions;
...
use BlackCat\Database\Packages\RbacUserPermissions\Repository\RbacUserPermissionRepository as GeneratedRepository;
...
{
  private RbacUserPermissionRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RbacUserPermissionRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RbacUserPermissionRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacUserPermissions\Dto\RbacUserPermissionDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacUserPermissions\Dto\RbacUserPermissionDto|null { return $this->repo->getById($id, $asDto); }
